...
export default class AppPage{
    constructor(){
        ...
        this.snackbarService = new SnackbarService(this.snackbarConfig);
        ...
        setTimeout(async () => {
            ...
            this.snackbarService.callNotification('online', `Seja Bem vindo(a) ${this.auth.auth.user['displayName']}`, '&check;');
            this.fetchContacts();
            this.fetchMessages();
        }, 300);
    ...
    async fetchUser(user){
        try{
            ...
            this.snackbarService.callNotification('online', `Seja Bem vindo(a) ${this.auth['name']}`, '&check;');
        }catch(e){
            console.error(e);
